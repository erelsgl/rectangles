...
var alg4walls = jsts.algorithm.halfProportionalDivision3Walls; // shorthand
...
describe('4 walls algorithm', function() {
	...
	it('2 agents with 4 points in corners - no intersection', function() {
		...
		alg4walls([agent1,agent2], square).slice(0).should.eql(
	...
	it('3 agents with 6 points - r-shape bug', function() {
		...
		testAlgorithm(alg4walls, [[agent1,agent2,agent3], square], 2);
	})
