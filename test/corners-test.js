...
describe('updatedCorners', function() {
	...
	it('works for 8 initial corners', function() {
		...
		updatedCorners(initialCorners, {minx:0,miny:2,maxx:2,maxy:4}).should.eql(
			[{x:0,y:Infinity},{x:0,y:4},{x:2,y:4},{x:2,y:0},{x:8,y:0},{x:8,y:2},{x:10,y:2},{x:10,y:Infinity}]);
		updatedCorners(initialCorners, {minx:0,miny:2,maxx:3,maxy:5}).should.eql(
			[{x:0,y:Infinity},{x:0,y:5},{x:3,y:5},{x:3,y:0},{x:8,y:0},{x:8,y:2},{x:10,y:2},{x:10,y:Infinity}]);
		updatedCorners(initialCorners, {minx:0,miny:2,maxx:8,maxy:10}).should.eql(
			[{x:0,y:Infinity},{x:0,y:10},{x:8,y:10},{x:8,y:2},{x:10,y:2},{x:10,y:Infinity}]);
		updatedCorners(initialCorners, {minx:0,miny:2,maxx:9,maxy:11}).should.eql(
