...
describe('1 wall algorithm', function() {
	...
	it('2 agents with 4 points, 2-leg tower', function() {
		...
		alg1walls([points], halfplane_N, 1, jsts.Side.South).length.should.be.above(1); // at least 2
	})
...
//			22,10,green:			162,200,green:			176,200,green:			292,10,green		
		...
		alg1walls([red,green], halfplane_N, 1, jsts.Side.South).length.should.be.above(1); // at least 2
	})
...
//		50,50,blue:	50,60,blue:	130,130,blue:	150,250,blue:	270,120,blue:	270,260,blue		
		...
		alg1walls([red,green,blue], halfplane_N, 1, jsts.Side.South).length.should.be.above(2); // at least 3
	})
	...
	it('6 agents with 10 points, eastern desert', function() {
		...
		alg1walls([points], halfplane_N, 1, jsts.Side.South).length.should.be.above(5);  // at least 6
	})
})
